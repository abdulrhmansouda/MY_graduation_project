...
<head>
    ...
    <title>CodePen - jquery repeater </title>
    ...
    -->
        <div data-repeater-list="category-group">
            <div data-repeater-item>
                ...
                <select type="text" name="cat-title">
                    <option value="html">html</option>
                    <option value="css">css</option>
                    <option value="js">js</option>
                </select>
                <input type="range" name="cat-slug" />
            ...
            (function($) {
                ...
                var buildFormInputs = function(fig) {
                    ...
                    if ($self.is('input, select, textarea')) {
                        ...
                        if ($self.is('input[type="email"]')) {
                            addInputsBasic('email', $self);
                        } else
                        if ($self.is('input[type="url"]')) {
            ...
            $.fn.repeater = function(fig) {
                ...
                $(this).each(function() {
                    ...
                    var $firstDeleteButton = $filterNested(
                        $filterNested($(this).find('[data-repeater-item]'), fig.repeaters).first().find(
