                        ...
                        <div class="card-body">
                            <form action="{{ route('company-register') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description"  cols="5" rows="5">{{ old('description','') }}</textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    <input type="password" class="form-control" placeholder="ConfirmPassword" name="password_confirmation">
                                </div>
                                ...
                                <div class="form-check form-check-info text-start">
                                    <input class="form-check-input" type="checkbox"  id="flexCheckDefault" name="agree" @if(old('agree')==='on') checked @endif>
